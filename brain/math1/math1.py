...
def generate_generic_question(description, start_year, end_year, initial_value, final_value, unit):
    ...
    b) Nếu vào năm {new_year}, {variable} là {new_value} {unit}. Hãy tính số năm cần để đạt được {variable} là {target_value} {unit}. Làm tròn kết quả đến số thập phân thứ 2.
    """
